...
\citet{shetrone_apache_2025} define a function to determine an upper limit on the abundance for a given $T_{\rm eff}$ and $S/N$. For most of the stars in our sample, the measured [Ce/H] is above this limit due to our $S/N>100$ requirement. However, at lower metallicities a larger fraction of our sample fall below the Ce limit, which affects our analysis of the MW halo in Section \ref{sec:halo}. Therefore, we calculate upper limits on [Ce/H] using the method of \citet{shetrone_apache_2025} and eliminate stars with abundance below the limit.
...
\todo{Discuss Figure \ref{fig:median-age-trends}.} Figure \ref{fig:median-age-trends} shows the variation in the [Ce/Mg] and $\Delta\bracket{Ce}$--age trends with guiding radius. Within the high-Ia population, both the [Ce/H] and $\Delta\bracket{Ce}$--age trends vary with $R_g$. The slope is steepest in the outer Galaxy ($R_g=13-15\kpc$) and flat in the inner Galaxy ($R_g=3-5\kpc$). \todo{Is the break at 6 Gyr ages important?}
