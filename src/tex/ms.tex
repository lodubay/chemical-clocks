...
Both the slope and intercept of the fits in Figure \ref{fig:local-metallicity-trends} vary with metallicity. Stars with either high or low metallicity show shallow or sometimes even positive slopes, with intercepts near Solar [Ce/Mg]. Stars with slightly sub-Solar metallicity ($\bracket{M}\approx-0.3$) have the steepest trends and the highest [Ce/Mg] at the present day.

\todo{Contrast with Casali fits.}
